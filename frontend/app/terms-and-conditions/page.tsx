export const metadata = {
  title: "Terms & Conditions | Anart Pharmacy",
  description:
    "Read the Terms & Conditions governing the use of the Anart Pharmacy website and services.",
};
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <p className="mb-6 text-gray-700 leading-8">
        ...
        collectively refer to <strong>Anart Pharmacy</strong>. The terms{" "}
      ...
      <p className="mb-10 text-gray-700 leading-8">
        ...
        using this Website. Anart Pharmacy reserves the right to revise these Terms and
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 leading-8 mb-4">
          ...
          this Website are the property of Anart Pharmacy or are used under appropriate
          license.
        </p>
      ...
      <section className="mb-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-6 text-gray-700 leading-8">
            ...
            Anart Pharmacy reserves the right to investigate suspected violations and
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 leading-8">
          ...
          harmless Anart Pharmacy, its directors, employees, officers, affiliates, and
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 leading-8 mb-4">
          You acknowledge that Anart Pharmacy shall not be liable for any direct,
        ...
        <p className="mt-6 text-gray-700 leading-8">
          Anart Pharmacy shall not be responsible for any actions, statements, or
          conduct of third parties using the Website. Where permitted by law,
          the total liability of Anart Pharmacy shall not exceed the amount paid by the
      ...
      <section>
        ...
        <p className="text-gray-700 leading-8">
          Under no circumstances shall Anart Pharmacy, its affiliates, partners,
          ...
          legal theory under which such damages are claimed and even if Anart Pharmacy
