    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg,#0D281B 0%,#153C29 60%,#255B40 100%)",
          }}
        >
          <div className="absolute right-[-120px] top-[-120px] h-[320px] w-[320px] rounded-full bg-white/5 blur-3xl" />

          <div className="absolute left-[-100px] bottom-[-120px] h-[250px] w-[250px] rounded-full bg-[#77C79F]/20 blur-3xl" />
