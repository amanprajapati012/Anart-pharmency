...
export const metadata: Metadata = {
  title: "Shipping & Delivery | Anart Pharmacy",
  description:
    "Learn about Anart Pharmacy's shipping, delivery timelines, order processing, and shipment tracking policy.",
};

export default function ShippingDeliveryPage() {
  return (
    <div className="min-h-screen bg-[#F2FAF6] py-16">
      <div className="max-w-5xl mx-auto px-6">
        {/* Hero */}
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#1D3B2C]">
            Shipping & Delivery
          </h1>

          <p className="mt-4 text-gray-600 max-w-2xl mx-auto leading-7">
            Thank you for shopping with Anart Pharmacy. We are committed to delivering
            your wellness products safely and on time across India.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <h2 className="text-2xl font-semibold text-[#1D3B2C] mb-4">
              Shipping Coverage
            </h2>
          ...
          {/* Contact */}
          <div className="bg-[#3C8B64] rounded-2xl text-white text-center p-8">
            ...
            <a
              href="/contact"
              className="inline-block bg-white text-[#3C8B64] font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 transition"
            >
              Contact Us
            </a>
          </div>
