          ...
          <div className="grid lg:grid-cols-[1.65fr_0.85fr] gap-14 lg:gap-24 items-start">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <label className="flex items-start gap-3 pt-2 cursor-pointer">
                  <span className="relative mt-1 flex-shrink-0">
                    ...
                    />
                    <span
                      className="flex h-5 w-5 items-center justify-center rounded border transition-all peer-checked:bg-[#0D281B] peer-checked:border-[#0D281B]"
                      style={{
                        borderColor: "#0D281B",
                        background: "#F8FCFA",
                      }}
                    >
                      <CheckCircle2
                        size={13}
                        strokeWidth={3}
                        className="hidden text-[#F8FCFA] peer-checked:block"
                      />
                    </span>
                  </span>
                  ...
                  >
                    ...
                    from Anart Pharmacy via call, SMS, email, WhatsApp, or RCS about
            ...
            >
              ...
              <div className="mb-12">
                ...
                >
                  <a
                    href="mailto:partners@anartpharmacy.com"
                    className="block hover:underline"
                  >
                    partners@anartpharmacy.com
                  </a>
                </div>
              </div>
