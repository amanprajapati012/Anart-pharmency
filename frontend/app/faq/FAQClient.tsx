...
const faqs = [
  {
    question: "What products does Anart Pharmacy offer?",
    answer:
      "Anart Pharmacy offers authentic Ayurvedic and herbal wellness products including Shilajit, herbal supplements, classical Ayurvedic formulations, immunity boosters, and natural personal care essentials.",
  },
  {
  ...
  {
    question: "How can I contact Anart Pharmacy?",
    answer:
...
export default function FAQClient() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] py-16 px-5">
      <div className="mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-gray-600">
            Find answers to the most common questions about Anart Pharmacy.
          </p>
        </div>
        ...
        <div className="mt-14 rounded-2xl bg-[var(--primary)] p-8 text-center text-white">
          ...
          <Link
            href="/contact"
            className="inline-block rounded-lg bg-white px-6 py-3 font-semibold text-[var(--accent)] transition hover:bg-gray-100"
          >
            Contact Us
          </Link>
        </div>
