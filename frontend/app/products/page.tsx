      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          >
            ...
            Filters
            {activeFilterCount > 0 && (
              <span className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-[#D19151] text-white text-[10px] flex items-center justify-center font-bold">
                {activeFilterCount}
              </span>
            )}
          </button>
              ...
              <div className="flex items-center justify-between">
                ...
                {activeFilterCount > 0 && (
                  <button
                    ...
                    className="text-xs font-semibold text-[#D19151] hover:underline"
                  >
                    Clear All
                  </button>
                )}
