  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="bg-[#CFECDE] border border-[#0D281B]/10 rounded-[24px] md:rounded-[30px] p-6 md:p-8 text-center max-w-md w-full">
          <h2 className="text-2xl md:text-3xl font-black text-foreground">
            Product Not Found
          </h2>

          <p className="text-[#4B6B5B] mt-3 text-sm md:text-base">
