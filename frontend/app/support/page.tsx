...
const offers = [
  { discount: "20% OFF", text: "on selected wellness products" },
...
export default function GetSupport() {
  ...
  const openWhatsApp = () => {
    window.open(
      `https://wa.me/${SUPPORT_NUMBER}?text=${encodeURIComponent(
        "Hello Anart Pharmacy, I need support regarding your products."
      )}`,
      "_blank"
    );
  };
  ...
  return (
    <main
      ...
      style={{ background: "#F8FCFA", color: "#0D281B" }}
    >
      {/* HEADER */}
      <header
        className="border-b"
        style={{ background: "#F8FCFA", borderColor: "#C0E5D2" }}
      >
      ...
      <button
        ...
        style={{ background: "#B9E3CE", color: "#0D281B" }}
            ...
            >
              ...
              >
                ...
                <img
                  ...
                  alt="Anart Pharmacy customer support"
            ...
            >
              ...
              <div className="text-center">
                ...
                >
                  ...
                  <br />
                  <a
                    href="mailto:care@anartpharmacy.com"
                    className="font-medium hover:underline"
                    style={{ color: "#0D281B" }}
                  >
                    care@anartpharmacy.com
                  </a>
                </p>
              </div>
      ...
      {/* ADDRESS */}
      <section className="py-20 md:py-24" style={{ background: "#EFF8F3" }}>
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  style={{ background: "#0D281B", color: "#F8FCFA" }}
                >
                  <Phone size={17} />
                  Call Now
                </button>
      ...
      >
        <div className="container mx-auto max-w-4xl px-6 text-center">
          ...
          <p
            ...
            style={{ color: "#C0E5D2" }}
          >
            Explore our collection of authentic Ayurvedic & herbal wellness products.
          </p>
