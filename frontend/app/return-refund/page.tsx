...
export const metadata: Metadata = {
  title: "Return & Refund Policy | Anart Pharmacy",
  description:
    "Read Anart Pharmacy's Return, Refund, Cancellation and Replacement Policy.",
};
    ...
    >
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          >
            At Anart Pharmacy, customer satisfaction is our top priority. We carefully
            inspect every product for quality before dispatch. If you experience
