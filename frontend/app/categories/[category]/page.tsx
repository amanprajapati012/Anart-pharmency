...
export default function CategoryPage() {
  ...
  category?.images?.length > 0
    ...
    return (
        <div className="min-h-screen bg-[#F1F9F5]">
            {/* HERO */}
           <section className="relative h-[280px] md:h-[500px] overflow-hidden rounded-b-[40px]">
            ...
            {/* FILTER */}
            <section className="sticky top-0 z-20 bg-[#F1F9F5]/95 backdrop-blur border-b border-[#BEE4D1]">
                <div className="max-w-7xl mx-auto px-4 py-5">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full h-12 pl-11 pr-4 rounded-xl border border-[#BCE3D0] bg-white outline-none"
                        />
                    </div>
