        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[320px_1fr] gap-6">
              ...
              {/* LEFT CARD */}
              <div className="bg-surface border border-[#0D281B]/10 rounded-[28px] p-6 text-center min-w-0">
              ...
              {/* RIGHT CARD */}
              <div className="bg-surface border border-[#0D281B]/10 rounded-[28px] p-4 md:p-6 min-w-0">
          ...
          <div className="w-full max-w-lg bg-surface rounded-[30px] p-6">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-2xl border border-[#0D281B]/20"
              >
                Cancel
              </button>
...
function InfoCard({ icon, title, value }: any) {
  return (
    <div className="bg-background border border-[#0D281B]/10 rounded-2xl p-4 flex gap-4 min-w-0">
  ...
  return (
    <div>
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full h-12 px-4 rounded-2xl border border-[#0D281B]/15 bg-background outline-none"
      />
    </div>
  );
}