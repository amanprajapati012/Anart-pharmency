      ...
      <div className="mb-6 flex flex-wrap items-end gap-3">
        <div className="min-w-[220px] flex-1">
          ...
          <select
            ...
            className="w-full rounded-xl border px-4 py-3 outline-none focus:ring-2 focus:ring-[#0D281B]"
          >
            <option value="">
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-20 rounded-lg border px-3 py-2 outline-none focus:ring-2 focus:ring-[#0D281B]"
                  />
