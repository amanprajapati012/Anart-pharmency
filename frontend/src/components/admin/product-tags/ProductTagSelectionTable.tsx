        ...
        return (
          <div className="flex justify-center">
            <input
              ...
              className="h-5 w-5 cursor-pointer accent-[#0D281B]"
            />
          </div>
        );
      },
    },
    {
      ...
      render: (row: Product) => (
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#BDE4D0] bg-white transition hover:bg-[#EEF8F3]"
        >
          <Pencil size={16} />
        </button>
      ),
