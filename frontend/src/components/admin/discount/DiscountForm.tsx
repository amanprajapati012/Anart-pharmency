...
export default function DiscountForm({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      ...
      >
        {/* HEADER */}
        <div className="px-6 py-4 border-b border-[#B7E1CC] flex justify-between items-center">
        ...
        <div className="p-6 grid grid-cols-2 gap-4">
          ...
          {/* VALUE */}
          <div className="flex items-center gap-2 p-3 rounded-xl bg-surface">
            <IndianRupee size={18} color="#0D281B" />
            <input
              type="number"
          ...
          {/* USER LIMIT */}
          <div className="flex items-center gap-2 p-3 rounded-xl bg-surface">
            <UserCheck size={18} color="#0D281B" />
            <input
              type="number"
        ...
        {/* FOOTER */}
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-[#B7E1CC]">
          <button
            onClick={() => setOpen(false)}
