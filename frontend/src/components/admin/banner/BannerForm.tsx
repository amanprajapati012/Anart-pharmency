...
const handleImageChange = async (
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-3 sm:p-5">
      ...
      >
        {/* HEADER */}
        <div className="border-b border-[#B7E1CC] px-4 sm:px-6 py-4 flex items-center justify-between shrink-0">
  ...
  <div key={index} className="relative">
    ...
    >
      ×
        ...
        {/* FOOTER */}
        <div className="border-t border-[#B7E1CC] p-4 sm:p-5 flex justify-end gap-3 shrink-0">
          <button
            onClick={() => setOpen(false)}
