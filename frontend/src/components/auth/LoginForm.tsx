...
export default function LoginForm() {
  ...
  <div className="min-h-screen flex items-center justify-center bg-background px-4 py-10">
    ...
    <div className="w-full max-w-md">
      ...
      {/* Card */}
      <div className="bg-surface rounded-3xl shadow-2xl border border-[#0D281B]/10 
                      max-h-[90vh] overflow-y-auto p-6 md:p-8">
        
        {/* Header */}
        <div className="text-center mb-6">
          <div className="w-14 h-14 mx-auto bg-[#D19151] rounded-2xl flex items-center justify-center text-white">
            <User size={24} />
          </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-white border border-[#0D281B]/10 
                       focus:ring-2 focus:ring-[#D4985D]/40 outline-none"
        ...
        <p className="text-center text-sm mt-5 text-foreground">
          ...
          <Link href="/auth/register" className="text-[#D4985D] font-semibold">
            Create Account
          </Link>
        </p>
