    ...
    <div className="w-full min-w-0 lg:sticky lg:top-24 space-y-5">
      ...
      <div className="min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#0D281B] to-[#1C4A33] text-white shadow-lg">
            <BadgeCheck size={14} />
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D19151] text-white shadow-lg">
        ...
        {!isVariant && (
          <p className="text-[#4F6C5E] text-sm md:text-lg mt-3 leading-7 break-words">
            {product.title}
          </p>
        )}
        ...
        <div className="flex flex-wrap items-center gap-4 mt-5">
          ...
          <div className="text-[#4F6C5E] text-sm">
            Ready To Dispatch
          </div>
        ...
        {(product?.tags?.length > 0 ||
          product?.category) && (
            <div className="flex flex-wrap gap-2 mt-5">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-[#EAF7F0] border border-[#0D281B]/10 text-foreground text-xs font-semibold">
                <Tag size={12} />
                {product.category}
              </div>
              ...
              {Array.isArray(product?.tags) &&
                product.tags.map(
                  (
                    ...
                    <div
                      key={index}
                      className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-[#EAF7F0] border border-[#0D281B]/10 text-foreground text-xs font-semibold hover:border-[#D19151] transition-all"
                    >
                      <Tag size={12} />
                      {tag}
                    </div>
...
<div className="bg-[var(--surface)] border border-bg-[var(--footer)]/10 rounded-[28px] p-6">
  ...
  <div className="flex flex-wrap items-center gap-3">
    ...
    <span className="text-xl md:text-2xl text-[#688F7C] line-through">
      ₹{active.price}
    </span>

    <span className="bg-footer text-[#D19151] px-3 py-2 rounded-full text-sm font-bold">
      {discount}% OFF
    </span>
  </div>
  ...
  <p className="mt-5 text-[#475F53] leading-7">
    {active.description}
  </p>
...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 -mt-1">
  ...
  <button
    ...
    className="h-14 md:h-16 rounded-2xl border-2 border-[#0D281B] bg-[#EAF7F0] text-foreground font-black flex items-center justify-center gap-2 hover:bg-footer hover:text-white transition-all"
  >
    ...
    Buy Now Securely
      ...
      <div className="bg-[var(--surface)] border border-bg-[var(--footer)]/10 rounded-2xl p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-12 h-12 rounded-xl bg-footer flex items-center justify-center text-[#D19151]">
            <ScanBarcode size={22} />
          </div>

          <div>

            <p className="text-xs text-[#576F63] uppercase tracking-wider">
              Product SKU
            </p>
      ...
      <div className="bg-[var(--surface)] border border-bg-[var(--footer)]/10 rounded-[28px] p-5 space-y-4">
        ...
        <div className="flex gap-4">
          <Truck className="text-[#D19151]" />
          <div>
            <h4 className="font-black text-foreground">
              Estimated Delivery
            </h4>
            <p className="text-[#536D60]">
              Jun 23 - Jun 27
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <PackageCheck className="text-[#D19151]" />
          <div>
            <h4 className="font-black text-foreground">
        ...
        <div className="flex gap-4">
          <ShieldCheck className="text-[#D19151]" />
          <div>
            <h4 className="font-black text-foreground">
              Secure Checkout
            </h4>
