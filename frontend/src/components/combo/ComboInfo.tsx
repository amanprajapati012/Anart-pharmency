    ...
    <div className="w-full min-w-0 lg:sticky lg:top-24 space-y-5">
      ...
      <div className="bg-[var(--surface)] border border-bg-[var(--footer)]/10 rounded-2xl md:rounded-[28px] p-4 sm:p-5 md:p-6">
        <div className="flex flex-wrap items-center gap-3">
          ...
          {combo.price > combo.discountedPrice && (
            <span className="text-lg sm:text-xl md:text-2xl text-[#688F7C] line-through">
              ₹{combo.price}
            </span>
          )}
        ...
        <p className="mt-5 text-[#475F53] leading-7">{combo.description}</p>
      </div>
      ...
      <div className=" grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 gap-4 -mt-1">
        <button
          ...
          className="h-12 sm:h-14 md:h-16 rounded-2xl border-2 border-[#0D281B] bg-[#EAF7F0] text-foreground font-black flex items-center justify-center gap-2 hover:bg-footer hover:text-white transition-all"
        >
      ...
      <div className="bg-[var(--surface)] border border-bg-[var(--footer)]/10 rounded-2xl md:rounded-[28px] p-4 sm:p-5 space-y-4">
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-[#536D60]">Jun 23 - Jun 27</p>
          </div>
        </div>
