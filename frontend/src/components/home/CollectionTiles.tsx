...
const collections = [
  {
    title: "Shilajit",
    desc: "Pure & lab-tested",
    img: "https://images.pexels.com/photos/6693662/pexels-photo-6693662.jpeg?auto=compress&cs=tinysrgb&w=1200",
    tall: true,
  },
  {
    title: "Herbal Wellness",
    desc: "Everyday immunity",
    img: "https://images.pexels.com/photos/4021775/pexels-photo-4021775.jpeg?auto=compress&cs=tinysrgb&w=1200",
    tall: false,
  },
  {
    title: "Classical Ayurveda",
    desc: "Time-tested formulations",
    img: "https://images.pexels.com/photos/6621460/pexels-photo-6621460.jpeg?auto=compress&cs=tinysrgb&w=1200",
    tall: false,
  },
  {
    title: "Personal Care",
    desc: "Natural, gentle, effective",
    img: "https://images.pexels.com/photos/4465831/pexels-photo-4465831.jpeg?auto=compress&cs=tinysrgb&w=1200",
    tall: true,
  },
];
...
export default function CollectionTiles() {
  ...
  return (
    <section className="relative bg-[var(--background)]  overflow-hidden">
      {/* Pattern */}
      <div className="absolute inset-0 opacity-[0.03] bg-[radial-gradient(#0D281B_1px,transparent_1px)] [background-size:28px_28px]" />
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mt-5 text-foreground/65 text-sm leading-7">
              Discover curated Ayurvedic collections — herbal wellness,
              Shilajit and daily-care essentials rooted in tradition.
            </p>

            <div className="flex gap-3 mt-8">
              <button
                onClick={scrollLeft}
                className="w-11 h-11 rounded-full border border-[#0D281B]/20 flex items-center justify-center hover:bg-footer hover:text-white transition-all"
              >
                <ArrowLeft size={18} />
              </button>
...
function CollectionCard({
  ...
  return (
    ...
    >
      ...
      {/* OVERLAY */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#0D281B]/80 via-[#0D281B]/30 to-transparent" />
