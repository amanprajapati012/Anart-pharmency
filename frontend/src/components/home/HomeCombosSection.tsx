...
export default function HomeCombosSection() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="pointer-events-none absolute -bottom-20 -right-20 w-72 h-72 rounded-full bg-[#D19151]/10 blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6">
          <div>
            ...
            >
              Combo Deals
              <span className="inline-flex align-middle ml-2 text-[#D19151]">
