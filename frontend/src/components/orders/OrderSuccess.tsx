        ...
        <section className="min-h-screen bg-[var(--surface)] py-12">
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="bg-[var(--surface)] rounded-[35px] border border-[var(--border)] overflow-hidden shadow-xl">
                    ...
                    <div className="bg-gradient-to-r from-[#0D281B] to-[#1F4B35] p-10 text-center text-white">
    ...
    {item.isVariant && item.variant_title
        ...
        : item.product_name}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-[#F8FCFA] rounded-3xl border border-[var(--border)] p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <Link
                                    ...
                                    className="bg-[#0D281B] text-white rounded-2xl py-4 flex justify-center items-center gap-2"
                                ...
                                <Link
                                    ...
                                    className="bg-[#BEE4D1] rounded-2xl py-4 text-center"
