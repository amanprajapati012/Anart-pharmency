...
export default function AvailableCoupons({
  ...
  return (
    <div className="mt-4 rounded-xl border border-[#A0D8BC] bg-[#EAF7F0] overflow-hidden">
      ...
      {open && (
        <div className="border-t border-[#A0D8BC]">
          ...
          {coupons.map((coupon) => (
            <div
              key={coupon._id}
              className="border-b last:border-0 border-[#BFE5D2] p-4"
            >
              <div className="flex justify-between items-start">

                <div>

                  <div className="font-bold text-[#1C3B2C]">
                    {coupon.code}
                  </div>
                ...
                <button
                  ...
                  className="rounded-lg bg-[#1C3B2C] px-4 py-2 text-white text-sm hover:bg-[#264B39]"
                >
                  Apply
                </button>
